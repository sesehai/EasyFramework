<?php
/** RequestException */
require_once(ROOT_PATH.'/core/request/Exception.php');

/** RequestAbstract */
require_once(ROOT_PATH.'/core/request/Abstract.php');
...
class RequestHttp extends RequestAbstract
{
     ...
     *
     * @return void
     * @throws RequestException when invalid URI passed
     */
    ...
    {
        throw new RequestException('Setting values in superglobals not allowed; please use setParam()');
    }
