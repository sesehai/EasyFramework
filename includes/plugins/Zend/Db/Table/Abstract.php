...
abstract class Zend_Db_Table_Abstract
{
    ...
    public function getReference($tableClassname, $ruleKey = null)
    {
        ...
        if ($ruleKey !== null) {
            if (!isset($refMap[$ruleKey])) {
                require_once ROOT_PATH."/includes/plugins/Zend/Db/Table/Exception.php";
    ...
    protected static function _setupAdapter($db)
    {
        ...
        if (is_string($db)) {
            require_once ROOT_PATH.'/includes/plugins/Zend/Registry.php';
    ...
    {
        require_once ROOT_PATH.'/includes/plugins/Zend/Db/Table/Select.php';
