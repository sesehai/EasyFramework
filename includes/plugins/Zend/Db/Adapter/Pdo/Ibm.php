...
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Adapter/Pdo/Abstract.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Db2 */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Adapter/Pdo/Ibm/Db2.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Ids */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Adapter/Pdo/Ibm/Ids.php';

/** @see Zend_Db_Statement_Pdo_Ibm */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Statement/Pdo/Ibm.php';
...
class Zend_Db_Adapter_Pdo_Ibm extends Zend_Db_Adapter_Pdo_Abstract
{
    ...
    public function _connect()
    {
        ...
        try {
            ...
            require_once ROOT_PATH.'/includes/plugins/Zend/Db/Adapter/Exception.php';
