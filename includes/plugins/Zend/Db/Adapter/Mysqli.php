 ...
 * @see Zend_Loader
 */
require_once ROOT_PATH.'/includes/plugins/Zend/Loader.php';

/**
 * @see Zend_Db_Adapter_Abstract
 */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Adapter/Abstract.php';

/**
 * @see Zend_Db_Profiler
 */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Profiler.php';

/**
 * @see Zend_Db_Select
 */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Select.php';

/**
 * @see Zend_Db_Statement_Mysqli
 */
require_once ROOT_PATH.'/includes/plugins/Zend/Db/Statement/Mysqli.php';
...
class Zend_Db_Adapter_Mysqli extends Zend_Db_Adapter_Abstract
{
    ...
    public function listTables()
    {
        ...
        if ($queryResult = $this->getConnection()->query($sql)) {
             ...
             */
            require_once ROOT_PATH.'/includes/plugins/Zend/Db/Adapter/Mysqli/Exception.php';
