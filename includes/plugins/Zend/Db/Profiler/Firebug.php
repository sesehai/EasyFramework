...
require_once ROOT_PATH.'/includes/plugins/Zend/Wildfire/Plugin/FirePhp.php';

/** Zend_Wildfire_Plugin_FirePhp_TableMessage */
require_once ROOT_PATH.'/includes/plugins/Zend/Wildfire/Plugin/FirePhp/TableMessage.php';
